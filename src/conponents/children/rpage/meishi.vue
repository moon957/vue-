<template>
  <div id="n-rmeishi">
     <nrtopblock :cailist="cailist" :name="name" ref="topblock"></nrtopblock>
...
export default {
  ...
  mounted(){
    ...
    var starty;
    var movey;
    this.$("#n-rmeishi").on("touchstart",function(e){
