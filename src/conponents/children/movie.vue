            ...
            <ul class="hot-movielist">
                <li class="hot-one"  v-for="(item,index) in moviedata" :key="index">
                    ...
                    <span class="lastblock">
                        <div>
                            <span><img v-for="(items,index) in Math.floor(item.pingfen/2)" :key="index" src="public/icon/huang.png" alt=""/></span>
                            <span><img v-for="(items,index) in 5-(Math.floor(item.pingfen/2))" :key="index" src="public/icon/xing.png" alt=""/></span>
    ...
    data(){
        return{
            ...
            moviedata:[{
                ...
                time:"20180821",
                pingfen:"10",
                src:"public/movie/alita.jpg",
                xing:"public/icon/xing.jpg",
                huangxing:"public/icon/huang.jpg"
            },
            {
                name:"天上掉下个猪八戒",
                time:"20180821",
